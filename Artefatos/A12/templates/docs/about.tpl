...
<h1>About</h1>
<p>Eventbook is a work in progress LBAW Class Project at <a
            href="https://sigarra.up.pt/feup/pt/web_page.inicial">FEUP</a></p>
<p>This website makes use of the <a href="http://getbootstrap.com/">Bootstrap Framework</a> and <a
            href="http://getbootstrap.com/components/#glyphicons">Glyphicons</a></p>
